...
These functions should be passed as `event_emitter` arguments to `Executor()`.
...
class SummaryLogger:
    ...
    ```python
        ...
        executor = Executor(..., event_emitter=summary_logger)
    ```
    """
